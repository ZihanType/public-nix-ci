...
This repository runs public CI work used by private Nix configurations. Its Chromium extension pipeline turns a small human-maintained catalog into immutable, content-addressed CRX artifacts.

## Chromium extension pipeline

The scheduled workflow reads [`extensions.jsonc`](./extensions.jsonc), publishes each resolved version through GitHub Immutable Releases, and updates [`extensions.lock`](./extensions.lock). It runs every four hours at minute 15 and can also be started manually.
